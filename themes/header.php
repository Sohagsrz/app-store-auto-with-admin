<html dir="ltr" class="i-amphtml-singledoc i-amphtml-standalone">
...
<head>
    ...
    <style amp-extension="amp-sidebar">
        amp-sidebar {
            --story-page-vh: 1vh;
            position: fixed !important;
            top: 0;
    ...
    <link href="/assets/css/3566091532-css_bundle_v2.css" rel="stylesheet" type="text/css">
...
<body style="opacity: 1; visibility: visible; animation: auto ease 0s 1 normal none running none; overflow: visible;" class="amp-mode-touch amp-mode-mouse amp-mode-keyboard-active">
    ...
    <style id="page-skin-1" type="text/css">
        ...
        * {
        ...
        .recent .title {
            ...
            text-align: center;
            font-size: 16px;
            background: url(https://lh3.googleusercontent.com/-Dm8yPXEZEb8/U2qdIaxbm4I/AAAAAAAAEEs/nNS9zkdI8UQ/h120/dot.png) rgba(0, 0, 0, 0.06)
        }
        ...
        .recent .title a {
            ...
            display: inline-block;
            padding: 3px 15px;
            font-family: Solaimanlipi, Kalpurush, Siyam Rupali
        }
        ...
        input#feed-q-input::-webkit-input-placeholder {
            color: #777;
        }
        ...
        .related-post-item-summary-text {
            display: none;
        }
        ...
        ul.recent_posts_with_thumbs li p {
            margin: .3em 0;
            font-size: 11px
        }
        ...
        .PopularPosts ul li .item-title a:hover,
        .PopularPosts ul li a:hover {
            color: #5b95f5;
        }

        #recent6 .recent-com a {
            background: #5b95f5;
            color: #fff;
            border: 0;
            padding: 8px 15px;
    ...
    <style id="template-skin-1" type="text/css">
        ...
        body#layout .mag-wrapper .widget {
            width: 95%;
            left: 20px;
            top: 10px;
        }

        body#layout .mag-wrapper:before {
            content: "Recent Posts Wrapper";
            font-size: 16px;
            color: #5b95f5;
            display: inline-block;
            font-weight: 600;
        ...
        body#layout #sidebar-wrapper:before {
            ...
            body#layout #footer:before {
                content: "Buy full version @ templatemark.com/pureapk";
                font-size: 13px;
                color: #ffffff;
                display: inline-block;
                background: #5b95f5;
    ...
    <style type="text/css">
        ...
        #recent2 .recent-box .imageContainer,
        #recent3 .recent-box .imageContainer,
        #recent4 .recent-box .imageContainer,
        #recent5 .recent-box .imageContaine,
        #recent6 .recent-box .imageContainer {
            width: 72px;
            float: left;
            height: 72px;
            margin-bottom: 8px;
        ...
        ul.recent_posts_with_thumbs li li {
            background: #fff;
            padding: 10px;
        }
        ...
        #recent1 .title {
            border-bottom: 2px solid #0bb1e6;
        }
        ...
        #recent2 .title {
            border-bottom: 2px solid #7d529e;
        }
        ...
        ul.recent_posts_with_thumbs li li:nth-child(10n) {
            border-bottom: 0 !important;
        }

        ul.recent_posts_with_thumbs li li:nth-child(11n) {
            border-bottom: 0 !important;
        }

        ul.recent_posts_with_thumbs li li:nth-child(12n) {
            border-bottom: 0 !important;
        }
        ...
        .adslot {
            width: 98%;
            background: rgba(31, 163, 118, 0.17);
            border: 1px solid #1FA376;
            padding: 10px;
            margin-bottom: 15px;
            text-align: left;
        ...
        @media screen and (max-width:1066px) {
            ...
            #recent6 ul.recent_posts_with_thumbs {
                padding: 0 !important;
                position: relative;
                width: 1050px;
            }
    ...
    <style type="text/css">
        ...
        .sharepost li .pinterest {
            background-color: #cc2127;
        }

        .sharepost li .linkedin {
    ...
    <div id="preloader" style="display: none;"><svg height="50px" version="1" viewBox="0 0 16 16" width="50px" xmlns="http://www.w3.org/2000/svg"><g class="qp-circular-loader"><path class="qp-circular-loader-path" d="M 8,1.125 A 6.875,6.875 0 1 1 1.125,8" fill="none" stroke-linecap="round" stroke-width="2.25"></path></g></svg></div>
...
<img alt="Pure APK" height="200px; " id="Header1_headerimg" src="//4.bp.blogspot.com/-RsfLLOhthlU/XaTkPZIoyqI/AAAAAAAADLM/Za8EQx9h3L4wB9p4IY59R_3_mRAAIhuYQCK4BGAYYCw/s1600/pure%2Bapk.png" style="display: block" width="400px; ">
</a>
                            </div>
                        </div>
                    </div>
