...
$limit= $_ENV['per_page'];
$offset= ($page-1)*$limit;
$total_cats= db()::table('srz_cats')->where([
    'type' =>'app'
    ])->count();
                                        ...
                                        foreach ($categories as $category) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-end">
                                                    ...
                                                    <a href="/dashboard/<?php echo $type;?>/delete?id=<?php echo $category->ID;?>" onclick="return confirm('Are you sure you want to Delete ?')" class="btn btn-sm btn-neutral"> <i class="bi bi-trash"></i></a>
                                                </td>
                                            </tr>
