                    ...
                    <table class="table table-hover table-nowrap">
                                    ...
                                    <tbody>
                                        ...
                                        <tr> 
                                            ...
                                            <td class="text-end">
                                            <a href="/page/<?php echo $movie->slug;?>" class="btn btn-sm btn-neutral" target="_blank"><i class="bi bi-eye"></i></a>
                                                <a href="/dashboard/<?php echo $type;?>/edit?id=<?php echo $movie->ID;?>" class="btn btn-sm btn-neutral"><i class="bi bi-pencil"></i></a>
                                                <a href="/dashboard/<?php echo $type;?>/delete?id=<?php echo $movie->ID;?>" onclick="return confirm('Are you sure you want to logout ?')" class="btn btn-sm btn-neutral"> <i class="bi bi-trash"></i></a>
                        ...
                        if($total_pages>1){
                          ...
                          <ul class="pagination justify-content-end ">
                                <li class="page-item <?php echo $page==1?'disabled':'';?>">
                                    <a class="page-link" href="/dashboard/movies?page=<?php echo $page-1;?>" tabindex="-1" aria-disabled="true">Previous</a>
                                </li>
                                <?php 
                                for($i=1;$i<=$total_pages;$i++){
                                    ?>
                                    <li class="page-item <?php echo $page==$i?'active':'';?>">
                                        <a class="page-link" href="/dashboard/movies?page=<?php echo $i;?>"><?php echo $i;?></a>
                                    </li>
                                    <?php
                                }
                                ?>
                                <li class="page-item <?php echo $page==$total_pages?'disabled':'';?>">
                                    <a class="page-link" href="/dashboard/movies?page=<?php echo $page+1;?>">Next</a>
                                </li>
                            </ul>
                        </nav>
                            <?php
